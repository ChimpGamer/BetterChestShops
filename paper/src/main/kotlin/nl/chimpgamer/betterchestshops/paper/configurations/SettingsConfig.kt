...
class SettingsConfig(plugin: BetterChestShopsPlugin) {
    ...
    val hologramHandler: String get() = config.getString("hologram.handler", "auto")
    val hologramRefreshInterval: Long get() = config.getLong("hologram.refresh.interval", 600L)
    val hologramOffSetX: Double get() = config.getDouble("hologram.offset.x", 0.5)
    val hologramOffSetY: Double get() = config.getDouble("hologram.offset.y", 1.0)
    val hologramOffSetZ: Double get() = config.getDouble("hologram.offset.z", 0.5)
