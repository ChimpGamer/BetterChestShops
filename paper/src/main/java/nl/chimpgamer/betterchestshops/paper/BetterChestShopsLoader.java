...
public class BetterChestShopsLoader implements PluginLoader {
    ...
    public void classloader(@NotNull PluginClasspathBuilder classpathBuilder) {
        var dependencies = new ArrayList<String>() {{
            add("org.jetbrains.kotlin:kotlin-stdlib:1.9.21");
            add("org.jetbrains.kotlin:kotlin-reflect:1.9.21");
            add("org.jetbrains.exposed:exposed-core:0.45.0");
            add("org.jetbrains.exposed:exposed-dao:0.45.0");
            add("org.jetbrains.exposed:exposed-jdbc:0.45.0");
            add("org.jetbrains.exposed:exposed-java-time:0.45.0");
